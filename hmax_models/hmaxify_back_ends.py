...
# VGG-16 Back-End Architecture --> Need to correct accoding to dicarlo's stride matching
class VGG16_BN_BackEnd(nn.Module):
    def __init__(self):
        super().__init__()
...
# HMAX S2b Back-End Architecture
class HMAX_BackEnd(nn.Module):
