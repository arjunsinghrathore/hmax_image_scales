...
class HMAX(nn.Module):
    def __init__(self,
        ...
        self.s2 = S2(channels_in=n_ori, channels_out=50, kernel_size=3, stride=1)
        ...
        self.s2b = S2(channels_in=n_ori, channels_out=12, kernel_size=[6, 9, 12, 15], stride=1)
        self.s3 = S3(channels_in=50, channels_out=50, kernel_size=3, stride=1)
