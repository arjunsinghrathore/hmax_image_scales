    ...
    def forward(self, x_pyramid, x_input = None, MNIST_Scale = None, batch_idx = None, category = None, \
        ...
        # Multi Scale band case ---> While Testing
            ...
            # # MaxPool over all positions first then scales (C2b)
                ...
                correct_scale_7_loss = 0
                correct_scale_8_loss = 0
                for sm_i in range(len(scale_max)):
                    if sm_i not in [7, 8]:
                        correct_scale_7_loss = correct_scale_7_loss + F.relu(scale_max[sm_i] - scale_max[7])
                        correct_scale_8_loss = correct_scale_8_loss + F.relu(scale_max[sm_i] - scale_max[8])
