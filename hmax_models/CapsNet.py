...
class PrimaryCaps(nn.Module):
    ...
    def forward(self, x):
        ...
        # u = u.view(x.size(0), 32 * 104 * 104, -1)
...
class DigitCaps(nn.Module):
    ...
    # def __init__(self, num_capsules=10, num_routes=32 * 104 * 104, in_channels=8, out_channels=16):
...
class Decoder(nn.Module):
    ...
    def forward(self, x, data, target = None):
        ...
        # reconstructions = reconstructions.view(-1, 1, 224, 224)
