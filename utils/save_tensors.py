...
def save_tensor(args, filter_maps, train_base_scale, prj_name, category, stage):
    ...
    file_name = os.path.join(job_dir, f"filters_data_{train_base_scale}.pkl")
    ...
    key_name = stage + '_scale_' + str(int(train_base_scale*1000)) + '_cat_' + str(category)
